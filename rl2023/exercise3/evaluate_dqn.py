...
from rl2023.exercise3.train_dqn import play_episode, CARTPOLE_CONFIG, SWEEP_RESULTS_FILE_CARTPOLE, ACROBOT_CONFIG
from rl2023.util.result_processing import Run, get_best_saved_run

ENV = "CARTPOLE" # "CARTPOLE" OR "ACROBOT"
RENDER = True
SWEEP_RESULTS_FILE_CARTPOLE = 'DQN--CartPole-v1--epsilon_start:1.0_epsilon_decay:0.001--2.pt'
